...
function modulardesign_insts(use_nat::Bool)
    return [((5, 5, n, use_nat),) for n in vcat(25, 25:25:300)]
end
...
function modulardesign_insts(pwl::PWLSOS2, options::NamedTuple)
    return [((5, 5, n, true, true, pwl, 128), options) for n in vcat(4, 4:2:18)]
end
